...
import 'package:service/api_response_entities/weather_main_resp.dart';
import 'package:service/api_response_entities/weather_resp.dart';
import 'package:service/api_response_entities/weather_sun_times_resp.dart';
import 'package:service/api_response_entities/weather_wind_resp.dart';
import 'package:service/network/weather_api.dart';
...
class WeatherApiServiceImpl implements WeatherApiService {
  ...
  @override
  Future<Weather> getWeatherByCityId(String cityId) => _api.GETWeatherByCityId(cityId: cityId).catchApiRequestErrors().then((value) => value.toEntity());
}
